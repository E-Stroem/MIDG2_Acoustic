...
void AcousticMPISend2d(Mesh *mesh);
void AcousticMPIRecv2d(Mesh *mesh);;
...
/* Acoustic functions */
void AcousticKernel2d(Mesh *mesh, float frka, float frkb, float fdt);
void AcousticKernel3d(Mesh *mesh, float frka, float frkb, float fdt);

void AcousticRHS2d(Mesh *mesh, float frka, float frkb, float fdt);
void AcousticRHS3d(Mesh *mesh, float frka, float frkb, float fdt);

void AcousticRun2d(Mesh *mesh, double FinalTime, double dt);
